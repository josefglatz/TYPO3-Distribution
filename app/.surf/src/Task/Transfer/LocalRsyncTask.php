...
namespace JosefGlatz\Surf\Task\Transfer;
 ...
 */
class LocalRsyncTask extends \TYPO3\Surf\Domain\Model\Task implements \TYPO3\Surf\Domain\Service\ShellCommandServiceAwareInterface
{
...
//        print_r($options);die;
        $localPackagePath = $options['arguments']['path'];
