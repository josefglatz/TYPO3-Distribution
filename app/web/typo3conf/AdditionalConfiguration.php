...
$customChanges = [
    ...
    'FE' => [
        ...
        'cHashExcludedParameters' => $GLOBALS['TYPO3_CONF_VARS']['FE']['cHashExcludedParameters'].', gclid', // see app/vendor/typo3/cms/typo3/sysext/core/Configuration/DefaultConfiguration.php:995ff for default parameters
